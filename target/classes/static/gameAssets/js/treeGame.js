...
var states = {
    preload: function() {
        ...
        this.preload = function () {
            ...
            game.load.image('startbutton','gameAssets/gameImg/startbutton.png');
            game.load.image('pausebutton','gameAssets/gameImg/pause.png');
    ...
    created: function() {
        this.create = function() {
            ...
            var remind = game.add.text(
                game.world.centerX, game.world.centerY - 50,
            ...
            var startbutton = game.add.button(game.world.centerX, game.world.centerY, 'startbutton', onStartClick, this, 1, 1, 0);
    ...
    play: function() {
        ...
        this.create = function() {
            ...
            var pauseButton = game.add.button(game.world.width-50, 60, 'pausebutton',onPauseClick,this, 1, 1, 0);
            pauseButton.scale.set(0.2);
            pauseButton.anchor.set(0.5,0.5);
            function onPauseClick() {
            	game.paused = true;
            	var pausedText = this.add.text(100, 250, "Game paused.\nTap anywhere to continue.",{fontSize: '40px',
                fontWeight: 'bold',
                fill: '#F9FF00'});
    ...
    over: function() {
        ...
        this.create = function() {
            ...
            var remind = game.add.text(game.world.centerX, game.world.height * 0.6, 'You can submit you score to Leaderboard~', {
                fontSize: '20px',
                fontWeight: 'bold',
                fill: '#F9FF00'
            });
            ...
            var startbutton = game.add.button(game.world.centerX, game.world.height * 0.75, 'startbutton', onStartClick, this, 1, 1, 0);
            startbutton.anchor.set(0.5,0.5);
            function onStartClick() {
                game.state.start('start');
            }
